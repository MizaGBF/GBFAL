...
class Updater():
    ...
    SCENE_BUBBLE_FILTER = set(["b1", "b2", "b3", "speed", "line", "up", "up2", "up3", "up4", "down", "shadow", "shadow2", "shadow3", "damage", "light", "vanish", "vanish1", "vanish2", "vanish3", "blood"])
